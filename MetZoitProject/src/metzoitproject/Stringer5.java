...
public class Stringer5 {
        static Graphics2D g2d;
        static Font[] fonts = {
                new Font("SansSerif", 1, 14),	// основной текст
                new Font("SansSerif", 1, 11),   // глваный индекс
                new Font("SansSerif", 1, 11)     // мелкие индексы
        };
...
//		System.out.println(s);
                ...
                while(true) {
                        ...
                        if (sym == '_') {
                                ...
                                x = drawSubstring(text2, x+5, y - 2-dy, sy + 1);
                                if (x1 > x) x = x1;
                        }
...
String U[], String D[], String strZ[],int fs, int count, int xx, int yy)
{
 ...
 int size=0, size1=0, size2=0, dl;
  ...
  Stringer5.fonts[0]=new Font("SansSerif", 1, fs);
  Stringer5.fonts[1]=new Font("SansSerif", 1, fs-3);
  Stringer5.fonts[2]=new Font("SansSerif", 1, fs-3);

 g.setFont(new Font("Dialog",1,fs));
 FontMetrics F=g.getFontMetrics();

 Stringer5.drawString(nach,xx,yy);
  ...
  if (strD[i].equals("@"))
    {
     if(i>0)
     {
      Stringer5.drawString(strZ[i-1]+" ",size,yy);
      size=size+F.stringWidth(strZ[i-1]+" ");
     }
     Stringer5.drawString(strU[i],size,yy);
    ...
    else
    {
     ...
     Stringer5.drawString(strU[i],size+((dl-size1)/2)+1,yy-8);
     Stringer5.drawString(strD[i],size+((dl-size2)/2)+1,yy+9);
