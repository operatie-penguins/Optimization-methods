...
//    static boolean writeEnabled;
	...
	static OwnListener ownListenerD = new OwnListener();
	...
	static {
	  checkButton.addActionListener(ownListenerD);
...
*/
			...
			//	f.addActionListener(ownListenerD);
			//	f.addFocusListener(ownListenerD);
				panel.add(f);
...
//System.out.println(text2);
				...
				b.addActionListener(ownListenerD);
...
class OwnListenerD extends FocusAdapter implements ActionListener {

	public void actionPerformed(ActionEvent e) {
		StringerD.infoEntered(e);
