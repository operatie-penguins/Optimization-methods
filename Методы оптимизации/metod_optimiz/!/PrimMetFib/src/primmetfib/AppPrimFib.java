 ...
 class  GrPanel extends JPanel {
  public void paintComponent(Graphics g) {
    super.paintComponent(g);
     ...
     g.setFont(new java.awt.Font("SansSerif", 1, 14));
     g.drawString("Найти минимум функции  f(x) методом Фибоначчи",63,15);
  ...
  //формулы
     ...
     Ind_n(g,"L"," 0",350,70);
     g.setFont(new java.awt.Font("SansSerif", 1, 12));
     g.drawString("  -   начальный",370,70);
     g.drawString("интервал ",420,85);
     g.drawString(" неопределенности",392,100);
     g.drawString("\u2113   -  допустимая длина",350,120);
     g.drawString("конечного интервала",382,135);
     g.drawString("\u03B5   -   константа",350,155);
     g.drawString(" различимости",419,170);
     g.drawString("N -  количество",350,190);
    ...
    if ((sh==8) || (sh==11)){
     ...
     // paintArrow(g,324,51,338,65);
      ...
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString(" Зададим начальные данные        ,    > 0 - константу различимости,",30,365);
      Ind_n(g, "L"," 0",250,365);
      g.drawString("\u03B5 ",280,365);
      g.drawString("   > 0 - допустимую длину конеч. интервала или точность. Построим ",10,385);
      g.drawString("функцию f(x).",10,405);
     }
      if (sh==2){
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      ...
      g.setColor(new Color(0, 0, 80));
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Найдем количество N вычислений функции как наименьшее целое",30,365);
      g.drawString("число, при котором выполняется условие                , и числа Фибоначчи",10,385);
      g.drawString(" ",10,405);
      Ind_n(g, "F"," N",313,385);
      Ind_n(g, "L"," 0",347,380);
      ...
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Положим k = 0. ",30,365);
      g.drawString("Вычислим       =     +         (     -     ),      =     +          (     -     )  ",10,385);
      Ind_n(g, "y"," 0",95,385);
      Ind_n(g, "a", "0",125,385);
    ...
    //  g.drawString("0",23,238);
      ...
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
     g.setColor(new Color(0, 0, 90));
      g.drawString("Вычислим значения функции  f(     ),   f(     )  в полученных точках",30,365);
      Ind_n(g, "y","0",265,365);
      Ind_n(g, "z","0",315,365);
      }
    if (sh==5){
     ...
     for (i=0;i<=14;i++)
      ...
      g.setColor(new Color(0, 0, 90));
      g.drawString("Сравним   f(     )  c  f(     ) : ",30,365);
      Ind_n(g, "y","0",123,365);
      Ind_n(g, "z","0",182,365);
      g.drawString("f(    ) < f(    ),  положим        =     ,       =     ,      =     ,       =      +            (     -     )",10,385);
      Ind_n(g, "y","0",20,385);
      Ind_n(g, "z","0",68,385);
      Ind_n(g, "a","1",181,385);
      Ind_n(g, "a","0",210,385);
     ...
     if (sh==6){
      ...
      g.setColor(new Color(0, 0, 90));
      g.drawString("Проверим условие окончания          =      -             и     k    N - 3,  ",30,365);
      Ind_n(g, "L"," 2",270,365);
      Ind_n(g, "b"," 1",304,365);
      Ind_n(g, "a"," 1",333,365);
      g.drawString("тогда   k = k + 1 = 0 + 1 = 1 ",10,385);
     ...
     if (sh==7){
      ...
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.setColor(new Color(0, 0, 90));
      g.drawString("Вычислим значениe функции  f(     ), а  значение   f(     ) = f(     )",30,365);
      Ind_n(g, "y","1",265,365);
      Ind_n(g, "z","1",400,365);
      Ind_n(g, "y","0",450,365);
      g.drawString("было найдено ранее. ",10,385);
   }
      if (sh==8){
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.setColor(new Color(180, 0, 60));
     ...
     if (sh==9){
      ...
      Ind_n(g, "b"," 2",304,365);
      Ind_n(g, "a"," 2",333,365);
      g.drawString("тогда   k = k + 1 = 1 + 1 = 2 ",10,385);
    ...
    if (sh==10){
      ...
      g.drawString("=",244,298);
      g.setColor(new Color(0, 0, 90));
      g.drawString("Вычислим значениe функции  f(    ), а  значение   f(     ) = f(     ) ",40,365);
      Ind_n(g, "z","2",270,365);
      Ind_n(g, "y","2",405,365);
      Ind_n(g, "z","1",455,365);
      g.drawString("было найдено ранее. ",10,385);
      ...
      g.setColor(new Color(0, 0, 90));
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Сравним   f(    )  c  f(    ) : ",40,365);
      Ind_n(g, "y","2",127,365);
      Ind_n(g, "z","2",183,365);
      g.drawString("f(    ) > f(    ),  положим        =     ,       =     ,       =     ,       =      +             (     -     )",10,385);
      Ind_n(g, "y","2",22,385);
      ...
      g.setColor(new Color(0, 0, 90));
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Проверим условие окончания        =      -       и  k = N - 3, тогда всегда ",40,365);
      Ind_n(g, "L"," 4",270,365);
      Ind_n(g, "b"," 3",304,365);
      Ind_n(g, "a"," 3",333,365);
      ...
      g.drawString("        =         =                     , т.е. отсутствует  точка  нового  вычисления",10,385);
      g.drawString("функции. Cледует положить            =         =            и           =         +  ",10,405);
      ...
      g.drawString("В нашем случае положим          =       =                 ,             =      =         и ",40,365);
      Ind_n(g, "y"," 4",410,365);
      Ind_n(g, "y"," 3",445,365);
      Ind_n(g, "z"," 3",475,365);
      g.drawString("    =      + ",15,385);
      ...
      g.setColor(new Color(0, 0, 90));
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Вычислим значение функции f(     ),  f(     ) в полученных точках и",40,365);
      Ind_n(g, "y","4",267,365);
      Ind_n(g, "z","4",315,365);
      g.drawString("найдем границы конечного интервала:  f(     ) <= f(     ), ",10,385);
      g.drawString("положим         =      ,       = ",10,405);
      Ind_n(g, "y","4",370,385);
      Ind_n(g, "z","4",310,385);
      Ind_n(g, "a"," 4",90,405);
      Ind_n(g, "a"," 3",120,405);
    ...
    if (sh==15){
     ...
     g.setColor(new Color(0, 0, 90));
      g.setFont(new java.awt.Font("SansSerif", 1, 14));
      g.drawString("Процесс поиска завершается        =        -        <        и          [      ,       ] .",40,365);
      Ind_n(g, "L"," N",266,365);
      ...
      Ind_n(g, "a"," 4",457,365);
      Ind_n(g, "b"," 4",485,365);
      g.drawString("В качестве приближенного решения можно взять любую точку ",10,385);
      g.drawString("последнего интервала, например, его середину :       =        .",10,405);
      Ind_n(g, "b"," 4",430,397);
      Ind_v(g, "x"," *",370,405);
