 ...
 //      OptimizationBasic.drawFormula(g1,"(1)",590,180,new java.awt.Font("SanSerief",1,14),new java.awt.Font("SanSerief",1,9));
     ...
     if(step>=5)
      {
	   ...
	   OptimizationBasic.drawFormula(g1,"\u2211 a_{ij} x_{j} = b_{i}, i = m_{1} + 1,... m_{2}",57,291,new java.awt.Font("SanSerief",1,14),new java.awt.Font("SanSerief",1,9));
       g1.setFont(new Font("SanSerief",1,9));
     ...
     if(step>=7)
      {
       if(step==7)
        g1.setColor(new Color(0,0,160));
         ...
         g1.setColor(new Color(0,0,80));
        g1.setFont(new Font("SanSerief",1,13));
		g1.drawString("Если задача разрешима, то ее оптимальный план совпадает, по крайней мере, c",50,400);
		g1.drawString("одним из опорных решений системы ограничений.",50,420);
      }
     if(step>=8)
      {
       if(step==8)
        g1.setColor(new Color(0,0,160));
         ...
         g1.setColor(new Color(0,0,80));
        g1.setFont(new Font("SanSerief",1,13));
		g1.drawString("Именно этот опорный план и",400,420);
		g1.drawString("отыскивается симплекс-методом в результате упорядоченного перебора опорных",50,440);
		g1.drawString("решений.",50,460);
      }
     if(step>=9)
      {
       if(step==9)
        g1.setColor(new Color(0,0,160));
         ...
         g1.setColor(new Color(0,0,80));
        g1.setFont(new Font("SanSerief",1,13));
		g1.drawString("Так как общее число опорных решений кончено, то через определенное",115,460);
		g1.drawString("число шагов будет найден оптимальный опорный план, либо установлена",50,480);
      }
	}
		 ...
		 if(step>=10)
		  {
		   if(step==10)
			g1.setColor(new Color(0,0,160));
			 ...
			 g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
			g1.drawString("неразрешимость задачи.",50,100);
		  }
		 if(step>=11)
		  {
		   if(step==11)
			g1.setColor(new Color(0,0,160));
			 ...
			 g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
			g1.drawString("Чтобы получить новый опорный план, первоначальный",220,100);
			g1.drawString("базис преобразовывают в новый. Для этого из первоначального базиса удаляют",50,120);
			g1.drawString("некоторую базисную переменную и вместо неё вводят другую из группы свободных.",50,140);
		  }
		 if(step>=12)
		  {
			g1.setColor(new Color(255,0,0));
		 ...
		 if(step>=19)
		  {
		   ...
		   g1.drawString("ограничения-равентсва путем прибавления ( вычетания ) к левым частям",50,400);
     ...
     if(step>=21 && step<=29)
     {
		 ...
		 if(step>=22)
		 {
			...
			g1.setColor(new Color(0,0,160));
			 ...
			 g1.setColor(new Color(0,0,80));
		 	g1.setFont(new Font("Dialog",1,13));
		 	g1.drawString("Говорят, что ограничение-равентсво канонической задачи имеет",50,120);
		 	g1.setFont(new Font("Dialog",2,13));
		 ...
		 if(step>=25)
		 {
			...
			g1.drawString("Свободные переменные",465,280);
		 	OptimizationBasic.drawFormula(g1,"приравниваются нулю: x_{j} = b_{j}, j = 1...m.",50,300,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=26)
		 {
		 	if(step==26)
		 ...
		 if(step>=27)
		 {
			...
			g1.setColor(new Color(0,0,160));
			 ...
			 g1.setColor(new Color(0,0,80));
		 	g1.setFont(new Font("Dialog",1,13));
		 	OptimizationBasic.drawFormula(g1,"X_{0} = ( b_{1}, b_{2}, ... , b_{n}, 0, ... , 0 ), (количество нулей: m)",50,340,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=28)
		 {
		 	if(step==28)
     ...
     if(step>=30 && step<=39)
     {
		 ...
		 if(step>=33)
		 {
		 	if(step==33)
				...
				g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
		 	g1.drawString("Свободные переменные приравниваются нулю, а препочительные (базисные)",80,260);
		 ...
		 if(step>=34)
		 {
		 	if(step==34)
				...
				g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
		 	g1.drawString("Т.о. начальный опорный план иммет вид:",320,280);
		}
		 if(step>=35)
		 {
		 	if(step==35)
     ...
     if(step>=40 && step<=43)
     {
        ...
        if(step>=43)
		{
	 	...
	 	g1.drawString("Составляем симплекс-таблицу...",50,280);
		}
	}
...
// /\i
		 ...
		 if(step>=50)
		 {
		 	if(step==50)
				...
				g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
			OptimizationBasic.drawFormula(g1,"1) \u2206_{j} \u2265 0 , i = 1...n + m, то план является оптимальным;",50,375,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=51)
		 {
		 	if(step==51)
				...
				g1.setColor(new Color(0,0,80));
			g1.setFont(new Font("Dialog",1,13));
			OptimizationBasic.drawFormula(g1,"2) \u2206_{j} < 0, при j = k, a_{ik} \u2264 0, то целевая функция не ограничена;",50,395,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=52)
		 {
		 	if(step==52)
		 ...
		 if(step>=53)
		 {
			...
			g1.drawString("одного из векторов и введением нового вектора.",50,455);
     ...
     if(step>=54 && step<=58)
     {
		 if(step>=54)
		 {
			...
			g1.setFont(new Font("Dialog",1,13));
			OptimizationBasic.drawFormula(g1,"Выберем максимальное значение |\u2206_{r}|.",50,275,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
			OptimizationBasic.drawFormula(g1,"Пусть\u2206_{r} - выбранное значение. Тогда столбец x_{r} будет ведущим. Переменную x_{r}",50,295,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
			OptimizationBasic.drawFormula(g1,"вводим в базис.",50,315,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
// rect 1
...
//----------------------------------
		 ...
		 if(step>=55)
		 {
			...
			OptimizationBasic.drawFormula(g1,"Вычислим отношения БР/a_{ir}.",50,335,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
...
//-------------------------2
		 if(step>=56)
		 {
		 	if(step==56)
				...
				g1.setColor(new Color(0,0,80));
			OptimizationBasic.drawFormula(g1,"Выберем ведущую строку min ( b_{1} / a_{1r}, ... , b_{m} / a_{mr}). Пусть отношение b_{k} / a_{kr}",50,355,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
			OptimizationBasic.drawFormula(g1,"минимальное. Тогда строка x_{n + k} - ведущая. Переменная x_{n + k} выводится из базиса.",50,375,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
...
//			g1.fillRect(260, 80, 35, 180);//|
		 ...
		 if(step>=57)
		 {
		 	if(step==57)
				...
				g1.setColor(new Color(0,0,80));
			OptimizationBasic.drawFormula(g1,"Теперь находим новый опорный план и коэффициенты разложения векторов,",50,395,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
			OptimizationBasic.drawFormula(g1,"через векторы нового базиса, соответстввующего новому опорному плану.",50,415,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=58)
		 {
		 	if(step==58)
			...
			OptimizationBasic.drawFormula(g1,"Составляем новую симплекс-таблицу.",50,435,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
	}
...
// /\i
		 ...
		 if(step>=64)
		 {
		 	if(step==64)
				...
				g1.setColor(new Color(0,0,80));
			OptimizationBasic.drawFormula(g1,"2) \u2206_{j} < 0, при j = k, a_{ik} \u2264 0, то функция не ограничена",50,415,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=65)
		 {
		 	if(step==65)
				...
				g1.setColor(new Color(0,0,80));
			OptimizationBasic.drawFormula(g1,"3) \u2206_{j} < 0, при j = k, хотя бы одно a_{ik} > 0, то можно перейти к новому опорному плану.",50,435,new java.awt.Font("Dialog",1,13),new java.awt.Font("Dialog",1,9));
		}
		 if(step>=66)
		 {
		 	if(step==66)
     ...
     if(step>=67 && step<=68)
     {
		 ...
		 if(step>=68)
		 {
			...
			g1.drawString("целевой функции.",50,180);
